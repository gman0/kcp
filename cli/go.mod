...
require (
	...
	github.com/kcp-dev/apimachinery/v2 v2.0.1-0.20250207161408-e1833e4a94f2 // indirect
	github.com/kcp-dev/client-go v0.0.0-20250210163812-5ae6774ab861 // indirect
