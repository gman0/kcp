...
func (in *BoundAPIResource) DeepCopyInto(out *BoundAPIResource) {
	*out = *in
	...
	if in.VirtualResource != nil {
		in, out := &in.VirtualResource, &out.VirtualResource
		*out = new(BoundVirtualResource)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BoundVirtualResource) DeepCopyInto(out *BoundVirtualResource) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BoundVirtualResource.
func (in *BoundVirtualResource) DeepCopy() *BoundVirtualResource {
	if in == nil {
		return nil
	}
	out := new(BoundVirtualResource)
