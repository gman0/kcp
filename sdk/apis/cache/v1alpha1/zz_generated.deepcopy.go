...
func (in *CachedAPIResourceSchema) DeepCopyInto(out *CachedAPIResourceSchema) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CachedAPIResourceSchema.
func (in *CachedAPIResourceSchema) DeepCopy() *CachedAPIResourceSchema {
	if in == nil {
		return nil
	}
	out := new(CachedAPIResourceSchema)
	in.DeepCopyInto(out)
	return out
}
