...
func TestDigestUrl(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			urlPath:             "/services/replication/my-cluster:my-export/my-cached-resource",
			expectedAccept:      true,
			expectedCluster:     request.Cluster{Name: "my-cluster", Wildcard: false, PartialMetadataRequest: false},
			expectedKey:         "my-cluster:my-export/my-cached-resource",
			expectedLogicalPath: "/services/replication/my-cluster:my-export",
		},
		{
			urlPath:             "/services/replication/*:my-export/my-cached-resource",
			expectedAccept:      true,
			expectedCluster:     request.Cluster{Name: "", Wildcard: true, PartialMetadataRequest: false},
			expectedKey:         "*:my-export/my-cached-resource",
			expectedLogicalPath: "/services/replication/*:my-export",
		},
		{
			urlPath:             "/services/replication/*/my-cached-resource",
		...
		{
			urlPath:             "/services/replication/my-cluster:my-export/my-cached-resource/something/else",
			expectedAccept:      false,
			expectedCluster:     request.Cluster{Name: "", Wildcard: false, PartialMetadataRequest: false},
			expectedKey:         "",
			expectedLogicalPath: "",
